...
import StudyPlanGenerator from '@site/src/components/StudyPlanGenerator/StudyPlanGenerator';
...
Create a personalized study plan that fits your schedule and learning goals.
